...
using Soenneker.Context7.Runners.OpenApiClient.Utils.Abstract;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Context7:ClientGenerationUrl"] ?? "https://context7.com/openapi.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Context7 OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "Context7OpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
    ...
    private async ValueTask BuildAndPush(string gitDirectory, CancellationToken cancellationToken)
    {
        ...
        if (!successful)
        {
            throw new InvalidOperationException("The generated Context7 client failed its Release build.");
        }
